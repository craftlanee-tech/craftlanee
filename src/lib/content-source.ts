export const rawContent = {
  ...
  hero: {
    ...
    stats: [
      { value: '360+', label: 'Digital growth setup' },
    ...
    items: [
      {
        ...
        description: 'Website redesign, GBP improvements, SEO pages, and lead forms for a service company.',
        image: '/images/ROI.png',
        result: 'More calls, clearer tracking',
      },
      {
  ...
  contact: {
    ...
    details: [
      { label: 'Email', values: ['hello@craftlanee.com', 'support@craftlanee.com'] },
      { label: 'Phone', values: ['+91 99000 00000', '+91 98000 00000'] },
      { label: 'Location', values: ['Hyderabad, India', 'Bengaluru, India'] },
    ],
  },
  testimonials: [
    {
