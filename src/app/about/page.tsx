    ...
    <main className="min-h-screen bg-theme-background text-theme-primary">
      ...
      <section className="px-6 py-20 sm:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center">
            ...
            <p className="mt-4 text-lg text-theme-secondary">A clear process for technology, marketing, training, and business transformation</p>
          </div>
      ...
      <section className="px-6 py-20 sm:px-10 bg-theme-surface-soft/50">
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center">
            ...
            <p className="mt-4 text-lg text-theme-secondary">A complete suite of technology, marketing, manpower, training, and workspace solutions</p>
          </div>
      ...
      <section className="px-6 py-20 sm:px-10">
        <div className="mx-auto max-w-3xl rounded-3xl bg-gradient-to-br from-theme-accent/20 to-theme-accent/5 border border-theme-accent/30 p-12 text-center backdrop-blur-sm">
          <h2 className="text-3xl font-bold md:text-4xl">Ready to build your next opportunity?</h2>
          <p className="mt-4 text-lg text-theme-secondary">Let's discuss your goals and shape the right CraftLanee solution.</p>
